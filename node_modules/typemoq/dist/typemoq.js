(function (global, factory) {
	...
	(factory((global.TypeMoq = global.TypeMoq || {}),global._,global.CircularJSON));
...
var StaticMock = (function (_super) {
    ...
    StaticMock.ofInstance = function (targetInstance, behavior) {
        targetInstance = StaticMock.cloneDeep(targetInstance);
        var mock = new StaticMock(targetInstance, true, behavior);
        return mock;
    };
    ...
    StaticMock.ofType = function (targetConstructor, behavior, targetConstructorArgs) {
...
var DynamicMock = (function (_super) {
    ...
    DynamicMock.ofType = function (name, behavior) {
        var mock = new DynamicMock((function () { }), name, true, behavior);
        return mock;
    };
...
var MockApi = (function () {
    ...
    MockApi.ofInstance = function (targetInstance, behavior) {
        if (behavior === void 0) { behavior = exports.MockBehavior.Loose; }
        var mock = StaticMock.ofInstance(targetInstance, behavior);
        return mock;
    };
    MockApi.ofType = function (targetConstructor, behavior) {
        if (behavior === void 0) { behavior = exports.MockBehavior.Loose; }
        var targetConstructorArgs = [];
        for (var _i = 2; _i < arguments.length; _i++) {
            targetConstructorArgs[_i - 2] = arguments[_i];
        }
        var mock;
        if (targetConstructor)
            mock = MockApi.ofType2(targetConstructor, targetConstructorArgs, behavior);
        else
            mock = DynamicMock.ofType(undefined, behavior);
        return mock;
    };
    MockApi.ofType2 = function (targetConstructor, targetConstructorArgs, behavior) {
        if (behavior === void 0) { behavior = exports.MockBehavior.Loose; }
        var mock = StaticMock.ofType(targetConstructor, behavior, targetConstructorArgs);
        return mock;
    };
    return MockApi;
}());
...
var GlobalMockApi = (function () {
    ...
    GlobalMockApi.ofType2 = function (globalName, container, behavior) {
        if (container === void 0) { container = window; }
        if (behavior === void 0) { behavior = exports.MockBehavior.Loose; }
        var mock = DynamicMock.ofType(globalName, behavior);
        return new GlobalMock(mock, undefined, GlobalType.Class, container);
    };
