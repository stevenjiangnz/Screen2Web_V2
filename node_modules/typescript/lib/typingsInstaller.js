...
(function (ts) {
    ...
    ts.version = ts.versionMajorMinor + ".0-dev.20171007";
})(ts || (ts = {}));
(function (ts) {
...
(function (ts) {
    ...
    ts.Diagnostics = {
        ...
        JSDoc_augments_is_not_attached_to_a_class_declaration: diag(8022, ts.DiagnosticCategory.Error, "JSDoc_augments_is_not_attached_to_a_class_declaration_8022", "JSDoc '@augments' is not attached to a class declaration."),
        JSDoc_augments_0_does_not_match_the_extends_1_clause: diag(8023, ts.DiagnosticCategory.Error, "JSDoc_augments_0_does_not_match_the_extends_1_clause_8023", "JSDoc '@augments {0}' does not match the 'extends {1}' clause."),
